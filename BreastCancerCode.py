...
Original file is located at
    https://colab.research.google.com/drive/1vEO-rwqxfjtdZwZJLq_mbPv3cerH-9y6
"""
...
#Drop all the columns with empty values
...
#Print the 5 new rows of the new data
df.head(5)
...
#Create a function for a models
